...
ATTACH: refs/singer.png (if regenerating, also refs/neleid-prince.png and refs/hall-boy.png)
...
ATTACH: refs/singer.png — then crop refs/muse.png from the result
MATCH LINE: "Match the attached reference image exactly: the elderly blind bard — same face, hair, beard, and dress."
PROMPT:
...
ATTACH: refs/gaia.png — then crop refs/zeus.png from the result
...
ATTACH: refs/zeus.png — then crop refs/themis.png from the result
MATCH LINE: "Match the attached reference image exactly: Zeus — same face, hair, beard, crimson robe, and eagle scepter."
PROMPT:
...
ATTACH: refs/zeus.png (for the feasting gods' style) — then crop refs/tantalus.png AND refs/laomedon.png from the result if their faces please you; otherwise they are born on pages 9 and 20
...
ATTACH: refs/zeus.png (+ refs/tantalus.png if you cropped him from pg08) — if Tantalus is new here, crop refs/tantalus.png from the result
...
ATTACH: refs/tantalus.png, refs/zeus.png
...
ATTACH: refs/zeus.png, refs/tantalus.png
...
ATTACH: refs/pelops.png — then crop refs/hippodamia.png from the result (she watches from the wall)
...
ATTACH: refs/hippodamia.png, refs/pelops.png
...
ATTACH: refs/hippodamia.png, refs/pelops.png — then crop refs/myrtilus.png from the result
...
ATTACH: refs/pelops.png, refs/myrtilus.png
...
ATTACH: refs/pelops.png, refs/hippodamia.png, refs/myrtilus.png — then crop refs/oenomaus.png from the result
...
ATTACH: refs/oenomaus.png, refs/myrtilus.png
...
ATTACH: refs/pelops.png, refs/myrtilus.png, refs/hippodamia.png
...
ATTACH: refs/thyestes.png (if cut)
...
ATTACH: refs/atreus.png, refs/thyestes.png (as available)
...
ATTACH: refs/atreus.png, refs/thyestes.png
...
ATTACH: refs/thyestes.png, refs/atreus.png
...
ATTACH: refs/laomedon.png (background), refs/poseidon-glimpse.png (for the mason's face echo)
...
ATTACH: refs/poseidon-mortal.png (if cut)
...
ATTACH: refs/laomedon.png, refs/poseidon-mortal.png, refs/apollo-mortal.png
...
ATTACH: refs/poseidon-mortal.png, refs/apollo-mortal.png
...
ATTACH: refs/heracles.png, refs/laomedon.png
...
ATTACH: refs/heracles.png, refs/hesione.png
...
ATTACH: refs/heracles.png, refs/hesione.png, refs/telamon.png
...
ATTACH: refs/heracles.png, refs/telamon.png, refs/laomedon.png
...
ATTACH: refs/heracles.png, refs/telamon.png, refs/hesione.png, refs/laomedon.png
...
ATTACH: refs/heracles.png, refs/telamon.png
...
ATTACH: refs/telamon.png, refs/heracles.png
...
ATTACH: refs/telamon.png, refs/hesione.png, refs/podarces.png
...
ATTACH: refs/hesione.png, refs/podarces.png, refs/heracles.png, refs/telamon.png
...
ATTACH: refs/hesione.png, refs/telamon.png
...
ATTACH: refs/zeus.png (style only, do not depict Zeus)
