...
Match the attached reference image exactly: the elderly blind bard — same face, hair, beard, and dress.
...
Match the attached reference images exactly: the first image is the elderly blind bard — same face, hair, beard, and dress; the second image is the young nobleman seated on the high seat — same face, hair, and blue mantle.
...
Match the attached reference image exactly: the colossal Earth-mother goddess — same face, foliage hair, and field-patterned robes.
...
Match the attached reference image exactly: the Earth-mother goddess — same face, foliage hair, and robes.
...
Match the attached reference image exactly: Zeus — same face, hair, beard, crimson robe, and eagle scepter.
...
Match the attached reference image exactly: the veiled goddess Themis — same face, veil, and silver-grey robes.
...
Match the attached reference image exactly: Zeus — same face, hair, and beard.
...
Match the attached reference images exactly: the first image is Zeus — same crimson robe and scepter; the second image is the veiled goddess Themis — same veil and silver-grey robes. Both are seen from behind.
...
Match the attached reference images exactly: the first image is the young nobleman — same face, fillet, armband, and blue mantle; the second image is the elderly blind bard singing in the background — same face, hair, and beard.
...
Match the attached reference image exactly for the enthroned god at the feast: same face, hair, beard, and crimson robe.
...
"Match the attached reference image exactly: Zeus at the head of the table — same face, hair, beard, and crimson robe." (add a second clause for Tantalus if attaching his ref)
...
Match the attached reference image exactly: the Lydian king — same face, ringleted beard, jewelry, and robe.
...
Match the attached reference images exactly: the first image is the Lydian king host — same face, beard, and robe; the second image is Zeus seated among the guests — same face, beard, and crimson robe.
...
Match the attached reference images exactly: the first image is Zeus rising in wrath — same face, beard, crimson robe; the second image is the Lydian king shrinking back — same face, beard, and robe.
...
Match the attached reference image exactly: the standing man — same face and ringleted beard, but haggard and ancient.
...
Match the attached reference image exactly: same face and ringleted beard, but haggard and ancient.
...
Match the attached reference images exactly: the first image is the elderly blind bard — same face, hair, beard, and dress; the second image is the young nobleman — same face, fillet, and blue mantle.
...
Match the attached reference image exactly: the young hero driving the chariot — same face, hair, ivory left shoulder, kilt.
...
Match the attached reference images exactly: the first image is the princess on the wall — same face, ringlets, diadem, blue and saffron dress; the second image is the hero below — same face and ivory shoulder.
...
Match the attached reference images exactly: the first image is the princess carrying the torch — same face, ringlets, and dress; the second image is the young hero beside her — same face and ivory shoulder.
...
Match the attached reference images exactly: the first image is the young hero — same face and ivory shoulder; the second image is the wiry charioteer — same face, beard, and leather kilt.
...
Match the attached reference images exactly: the first image is the young hero driving the lead chariot — same face and ivory shoulder; the second image is the princess beside him — same face, ringlets, and dress; the third image is the charioteer driving the pursuing chariot — same face and leather kilt.
...
Match the attached reference images exactly: the first image is the black-armored king tangled in the reins — same helmet and grey beard; the second image is the charioteer leaping clear — same face and leather kilt.
...
Match the attached reference images exactly: the first image is the dying king raised on one arm — same face and grey beard, helmet fallen; the second image is the charioteer standing apart — same face and kilt.
...
Match the attached reference images exactly: the first image is the young hero, now wearing a king's cloak — same face and ivory shoulder; the second image is the charioteer arguing with him — same face and kilt; the third image is the princess standing apart by the chariot — same face and dress, face averted.
...
Match the attached reference image exactly: the falling man — same face, beard, and leather kilt.
...
Match the attached reference image exactly: the cloaked king half-turned away — same face and ivory shoulder.
...
Match the attached reference image exactly: the lean dark-green-robed prince — same face and pointed beard.
...
Match the attached reference images exactly: the first attached image is the purple-mantled king with arms raised (refs/atreus.png) - reproduce that face, hair and apparent age exactly; the second attached image is the green-robed prince staggering back (refs/thyestes.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the enthroned purple-mantled king (refs/atreus.png) - reproduce that face, hair and apparent age exactly; the second attached image is the travel-worn green-robed suppliant (refs/thyestes.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the king seated at the table's head, not eating, watching (refs/atreus.png) - reproduce that face, hair and apparent age exactly; the second attached image is the lean prince eating heartily (refs/thyestes.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the prince on his feet in horror (refs/thyestes.png) - reproduce that face, hair and apparent age exactly; the second attached image is the king leaning back savoring (refs/atreus.png) - reproduce that face, hair and apparent age exactly.
...
the aged green-robed man, now grey-streaked and gaunt.
...
first image: the blind bard, face lifted; second image: the young nobleman, pale and grave.
...
the crowned king may appear small on a distant platform; give the huge mason a hint of the attached bearded god's face.
...
the crowned Anatolian king on the platform.
...
the huge grey-bearded mason regarding the wall.
...
Match the attached reference images exactly: the first attached image is the enthroned crowned king (refs/laomedon.png) - reproduce that face, hair and apparent age exactly; the second attached image is the huge mason with hand out (refs/poseidon-mortal.png) - reproduce that face, hair and apparent age exactly; the third attached image is the golden-haired herdsman beside him (refs/apollo-mortal.png) - reproduce that face, hair and apparent age exactly.
...
the crowned king on his feet pointing.
...
Match the attached reference images exactly: the first attached image is the huge mason (refs/poseidon-mortal.png) - reproduce that face, hair and apparent age exactly; the second attached image is the golden youth (refs/apollo-mortal.png) - reproduce that face, hair and apparent age exactly.
...
the crowned king before the altar.
...
Match the attached reference images exactly: the first attached image is the lion-hooded hero, arms folded (refs/heracles.png) - reproduce that face, hair and apparent age exactly; the second attached image is the crowned king, hands spread, desperate (refs/laomedon.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the lion-hooded hero in the surf (refs/heracles.png) - reproduce that face, hair and apparent age exactly; the second attached image is the chained princess behind him (refs/hesione.png) - reproduce that face, hair and apparent age exactly.
...
the lion-hooded hero astride the monster's neck.
...
Match the attached reference images exactly: the first attached image is the hero snapping the chain (refs/heracles.png) - reproduce that face, hair and apparent age exactly; the second attached image is the princess steadying herself, regal (refs/hesione.png) - reproduce that face, hair and apparent age exactly; the third attached image is the boar's-tusk-helmed warrior wading in, unable to look away from her (refs/telamon.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the lion-hooded hero, face darkening (refs/heracles.png) - reproduce that face, hair and apparent age exactly; the second attached image is the warrior beside him (refs/telamon.png) - reproduce that face, hair and apparent age exactly; the third attached image is the bland-faced crowned king (refs/laomedon.png) - reproduce that face, hair and apparent age exactly.
...
map each briefly; the princess watches from the wall, hand at her throat; the king laughs small in the background.
...
map each: "at the prow of the lead galley."
...
the boar's-tusk-helmed warrior leading the ram crew.
...
the warrior first through the breach.
...
Match the attached reference images exactly: the first attached image is the lion-hooded hero stopping dead, jealous darkness on his face (refs/heracles.png) - reproduce that face, hair and apparent age exactly; the second attached image is the warrior ahead in the breach dust (refs/telamon.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the warrior on one knee piling stones (refs/telamon.png) - reproduce that face, hair and apparent age exactly; the second attached image is the hero above him, the shadow passing into a laugh (refs/heracles.png) - reproduce that face, hair and apparent age exactly.
...
the crowned king at bay on the palace steps, now in armor.
...
the lion-hooded hero drawing the great bow.
...
the lion-hooded hero looking down at the boy.
...
map each: "the warrior with the princess beside him" / "the boy among the captives, looking at her."
...
map each: "the princess holding her veil out over the boy's head" / "the hero watching arms folded" / "the warrior nodding."
...
the boy's solemn face beneath the held veil.
...
map each: "the princess at the stern rail looking back."
...
the boy crowned on the scorched throne.
...
divine faces in the manner of the attached radiant god style, but one sea-grey and one golden.
...
Match the attached reference images exactly: the first attached image is the young noble asking quietly (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly; the second attached image is the bard answering (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
the bard's face lifted toward the doorway.
