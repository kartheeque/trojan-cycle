...
Match the attached reference images exactly: the first attached image is the blind bard being led to his stool (refs/singer.png) - reproduce that face, hair and apparent age exactly; the second attached image is the young noble on the high seat (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the young noble leaning forward eagerly (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the blind bard with one hand raised, faint smile (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the bard's face lifted, fingers on the strings (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the radiant Muse half-seen above the hearth smoke (refs/muse.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the queen walking with her women (refs/leda.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the queen alone at the bank (refs/leda.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the queen with arms half-raised around the radiant swan (refs/leda.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the troubled reverent king (refs/tyndareus.png) - reproduce that face, hair and apparent age exactly; the second attached image is the calm queen (refs/leda.png) - reproduce that face, hair and apparent age exactly.
...
the king = refs/tyndareus.png — match his face EXACTLY: the same lean careworn face, long straight grey-white beard (not curly, not full), hair swept back from the brow. The queen = refs/leda.png — match her face exactly. Do not invent new faces for either.
...
'the radiant golden-haired girl' = refs/helen-child.png (match her face exactly); the mother in the background = refs/leda.png.
...
map each; the golden-haired girl at center is the attached child reference.
...
Match the attached reference image exactly: it is the aging hero-king rising, decision hardening his face (refs/theseus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the golden-haired girl among the dancers (refs/helen-child.png) - reproduce that face, hair and apparent age exactly.
...
map each: 'the grey-streaked king carrying off the crying child' = refs/theseus.png / 'the child' = refs/helen-child.png — match her face AND her apparent age exactly.
...
map each: the staggering king = refs/tyndareus.png / the queen gripping his arm = refs/leda.png; behind them two IDENTICAL young men's faces going hard.
...
Match the attached reference image exactly: it is the child seated stiff and unbowed (refs/helen-child.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the old guardian (refs/aethra.png) - reproduce that face, hair and apparent age exactly; the second attached image is the child staring south (refs/helen-child.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the aging king with a hand on each son's shoulder (refs/tyndareus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the frowning young noble (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly; the second attached image is the calm bard (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the bard lifting one hand (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the bard turning back toward the fire, light rising (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the aging king watching the road fill, joy and dread mixed (refs/tyndareus.png) - reproduce that face, hair and apparent age exactly.
...
map each among the suitors at table.
...
Match the attached reference image exactly: it is the king sleepless by a lamp (refs/tyndareus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the compact traveler leaning against a pillar, watching (refs/odysseus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the traveler's look across the court (refs/odysseus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the king gripping the parapet, turning (refs/tyndareus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the traveler, half-smile gone, entirely serious (refs/odysseus.png) - reproduce that face, hair and apparent age exactly.
...
map each: the king with staff at the head; the compact traveler at the ring's edge watching; the great suitors prominent in the ring.
...
Match the attached reference images exactly: the first attached image is the king rising with his staff (refs/tyndareus.png) - reproduce that face, hair and apparent age exactly; the second attached image is the golden-haired princess before the throne with a myrtle garland (refs/helen.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the golden princess placing the garland (refs/helen.png) - reproduce that face, hair and apparent age exactly.
...
map each in the garlanded chariot.
...
Match the attached reference image exactly: it is the new queen at the top of the steps, face unreadable, faintly sad (refs/helen.png) - reproduce that face, hair and apparent age exactly.
...
map each; the traveler waits apart.
...
map each, hands joined at the altar.
...
map each: the pleading father, the couple by a readied chariot.
...
map each: the chariot moving; the father following on foot with raised arms.
...
map each: he has halted the horses and turned to her, asking not commanding.
...
Match the attached reference images exactly: the first attached image is 'she draws her veil across her face (refs/penelope.png) - reproduce that face, hair and apparent age exactly; the second attached image is the father stopped in the road behind.' (refs/icarius.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is he working with adze (refs/odysseus.png) - reproduce that face, hair and apparent age exactly; the second attached image is she watching from the doorway (refs/penelope.png) - reproduce that face, hair and apparent age exactly.
...
map each seated together on the porch.
...
map each in the chariot entering the gate.
...
map each enthroned, the court adoring.
...
map each enthroned, colder register.
...
map each embracing between chariots.
...
Match the attached reference image exactly: it is across the court, the compact traveler, the only other man not laughing (refs/odysseus.png) - reproduce that face, hair and apparent age exactly.
...
map each enthroned side by side.
...
Match the attached reference image exactly: it is the veiled goddess counting off on her fingers, measured and calm (refs/themis.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the king of the gods looking down through the cloud-floor (refs/zeus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the bard, gentle and grave (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the bard lifting one finger, the teacher's gesture (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the young noble, half-smiling now (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the bard's blind face toward the doorway and the stars (refs/singer.png) - reproduce that face, hair and apparent age exactly.
