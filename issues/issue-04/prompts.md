...
Match the attached reference image exactly: it is the herdsman lit by divine radiance (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is quiet, almost reluctant (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is grave assent (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is 'the bard's face lifted (refs/singer.png) - reproduce that face, hair and apparent age exactly; the second attached image is the Muse faint above.' (refs/muse.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the herdsman by his fire as the lights arrive (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is fallen back against a pine, arm across his eyes (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
map each: the herald drawing him up by the wrist.
...
Match the attached reference image exactly: it is his face in its glow (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is majesty entire (refs/hera.png) - reproduce that face, hair and apparent age exactly; the second attached image is the herdsman small before her (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the herdsman throned in gold in the dream (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is staring into the vision, the apple heavy (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is calm, grey eyes level, unhurried (refs/athena.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the herdsman in shining armor; and grey among elders (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is shaken; hands tighten on the apple (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is simply smiling; the air gone warm (refs/aphrodite.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is a veiled woman of unbearable radiance by a far hearth (refs/helen.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is his face, undone (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
map each: the apple passing to the smiling goddess; the two turning away COLD; the herald pitying.
...
Match the attached reference images exactly: the first attached image is the goddess remaining (refs/aphrodite.png) - reproduce that face, hair and apparent age exactly; the second attached image is the judge kneeling, changed (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
'lifting his chin with one finger.'
...
Match the attached reference image exactly: it is alone at dawn, Troy far below (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is protesting, waved aside (refs/agelaus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is arriving too late, decision hardening (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
'the old man gripping his arm, dread naked.'
...
map each among the competitors.
...
map each: the victor before the royal stand; the king and queen staring.
...
Match the attached reference images exactly: the first attached image is the shamed prince drawing (refs/deiphobus.png) - reproduce that face, hair and apparent age exactly; the second attached image is the victor springing back (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
map each: her arms flung wide between the blade and the stranger.
...
map each: the old herdsman kneeling, holding up the tokens.
...
map each: the king taking the young man's face in both hands; the queen weeping.
...
map each: the restored prince in princely robes between his parents; the crown prince embracing him.
...
Match the attached reference image exactly: it is pointing at the feast, voice breaking against the joy (refs/cassandra.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the king gentle and immovable (refs/priam.png) - reproduce that face, hair and apparent age exactly; the second attached image is the seeress led out (refs/cassandra.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is hands pressed together, disbelieving (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is gently explaining the most dangerous feeling (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is grave, the gold light rising (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the prince watching the ship grow; a golden shimmer at his shoulder (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
map each: the two seers together before the king.
...
Match the attached reference images exactly: the first attached image is the king choosing the joy (refs/priam.png) - reproduce that face, hair and apparent age exactly; the second attached image is the son bowing (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the prince at the stem (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the apple-light in his eyes (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
map each: the host clasping the guest's wrist on the palace steps.
...
Match the attached reference image exactly: it is looking up from among her women (refs/helen.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is frozen mid-word at the sight of her (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is returning the look once — then down at her spindle (refs/helen.png) - reproduce that face, hair and apparent age exactly.
...
map each: the two mortals small at either side; the goddess faint between them.
...
map each: the goddess vast and translucent above the hall; golden threads to the two mortals; the host threadless and laughing.
...
Match the attached reference image exactly: it is a dusty herald kneeling with news (refs/menelaus.png) - reproduce that face, hair and apparent age exactly.
...
map each: the leave-taking of full trust.
...
Match the attached reference image exactly: it is on the shore, watching it go: the guest (refs/paris.png) - reproduce that face, hair and apparent age exactly.
...
map each: the goddess seated beside her like kin.
...
Match the attached reference image exactly: it is standing apart, arms folded, dark with shame (refs/aeneas.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference images exactly: the first attached image is the veiled queen pausing on the gangplank (refs/helen.png) - reproduce that face, hair and apparent age exactly; the second attached image is the prince's hand (refs/paris.png) - reproduce that face, hair and apparent age exactly; the third attached image is the goddess behind (refs/aphrodite.png) - reproduce that face, hair and apparent age exactly.
...
map each on the wall above the harbor.
...
Match the attached reference image exactly: it is standing in his own doorway; the hall dim and bare (refs/menelaus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is not raging; going very still (refs/menelaus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is on his feet in protest (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is a long silence; an old sorrow (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is the vision-light rising, but colder (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
map each driving the herd below.
...
Match the attached reference image exactly: it is hidden in the hollow of a great oak, spear ready (refs/castor.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is pale eyes catching moonlight, seeing through the oak; arm flinging out (refs/lynceus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is fallen from the hollow, hand at the wound (refs/castor.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is arriving like weather; the sky opening white above the fleeing slayer (refs/polydeuces.png) - reproduce that face, hair and apparent age exactly.
...
map each: the immortal cradling the mortal.
...
map each: the sky opened in majesty above the kneeling brothers.
...
Match the attached reference images exactly: the first attached image is 'not rising (refs/polydeuces.png) - reproduce that face, hair and apparent age exactly; the second attached image is his brother's head against his shoulder.' (refs/castor.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is an old man alone in the doorway of the empty exercise-ground (refs/tyndareus.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is years hence, searching the host from the high wall (refs/helen.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is wiping his eyes, angry at himself (refs/neleid-prince.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is shaking his head slowly (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is rising, weary (refs/singer.png) - reproduce that face, hair and apparent age exactly.
...
Match the attached reference image exactly: it is at the doorway; two stars low over the water (refs/singer.png) - reproduce that face, hair and apparent age exactly.
