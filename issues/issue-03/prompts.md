...
MATCH LINE: 'the young noble, eager.'
...
MATCH LINE: 'the bard nodding slowly.'
...
MATCH LINE: 'the bard's face lifted; the Muse faint in the smoke above.'
...
REF-BIRTH: refs/priam.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
REF-BIRTH: refs/hecuba.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
MATCH LINE: map each together at the rail.
...
MATCH LINE: 'the king on the low dais.'
...
REF-BIRTH: refs/antenor.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.

### i03-pg06-pn2.png — standard 4:3 — ANTENOR COUNSELS
ATTACH (fetch from repo refs/ and attach to the generation): refs/antenor.png
MATCH LINE: 'the old counselor speaking, finger raised.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/priam.png
MATCH LINE: 'the king rising from the dais, calm.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/priam.png
MATCH LINE: 'one hand toward the east window, one toward the sea.'
...
MATCH LINE: map each; the seer casting lots before them.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/priam.png, refs/hecuba.png
MATCH LINE: map each: the queen turned away; the king rigid.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/priam.png
MATCH LINE: 'the king not looking at the kneeling herdsman.'
...
REF-BIRTH: refs/agelaus.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.

---

### i03-pg10-pn1.png — wide 16:9 — INTO THE WILDS
ATTACH (fetch from repo refs/ and attach to the generation): refs/agelaus.png
MATCH LINE: 'the herdsman climbing with the bundle.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/agelaus.png
MATCH LINE: 'the herdsman returned, staff fallen, staring.'
...
REF-BIRTH: refs/paris.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
MATCH LINE: map each: the youth at ease; the old man watching with troubled love.
...
MATCH LINE: 'the youth alone on a crag at dusk.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/paris.png
MATCH LINE: 'the young herdsman with his garlanded champion.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/paris.png
MATCH LINE: 'the youth garlanding the stranger's bull with his own hands.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/neleid-prince.png
MATCH LINE: 'the young noble, moved.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/singer.png
MATCH LINE: 'the vision-light rising around the bard.'
...
REF-BIRTH: refs/thetis.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
MATCH LINE: map each: the veiled goddess with hand raised in warning.
...
MATCH LINE: 'the king of the gods, sober, setting down desire like a cup.'
...
REF-BIRTH: refs/peleus.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
MATCH LINE: map each: he holds; she transforms.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/peleus.png, refs/thetis.png
MATCH LINE: map each: she stands free in her own form; he kneels, head bowed.
...
MATCH LINE: 'her immortal face moving from cold to wonder to sorrow.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/peleus.png, refs/thetis.png
MATCH LINE: map each walking together, not touching.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/thetis.png
MATCH LINE: 'her face out to sea, the grief of all the sea in it.'
...
REF-BIRTH: refs/chiron.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
REF-BIRTH: refs/hermes.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
REF-BIRTH: refs/eris.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/zeus.png
MATCH LINE: 'the king of the gods foremost.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/thetis.png
MATCH LINE: 'the bride veiled in sea-silver between torches.'
...
MATCH LINE: map each: Zeus presiding; the couple at the head; the centaur presenting a great ash spear; the strife-goddess tiny in the outer dark.
...
MATCH LINE: map each: the centaur laying the spear in the king's hands.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/thetis.png
MATCH LINE: 'her smile and her grief in one face.'
...
MATCH LINE: 'the strife-goddess stepping to the rim of the torchlight.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/eris.png
MATCH LINE: 'the bitter beautiful face, the feast reflected small in her eyes.'
...
MATCH LINE: map each risen to her feet.
...
MATCH LINE: 'crowned, terrible in majesty.'
...
MATCH LINE: 'calm and absolute, spear grounded.'
...
MATCH LINE: 'smiling, and the smile itself the argument.'
...
MATCH LINE: map each: the three turned as one to the enthroned king.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/zeus.png
MATCH LINE: 'sovereign and unreadable, slowly shaking his head.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/zeus.png
MATCH LINE: 'looking away east and down through the night.'
...
MATCH LINE: map each: the herald receiving the apple, his quick face grave.
...
MATCH LINE: map each in the night sky.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/priam.png, refs/hecuba.png
MATCH LINE: map each on the terrace; behind them the grown crown prince.
...
REF-BIRTH: refs/hector.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.
...
REF-BIRTH: refs/cassandra.png — not the image generator's task: after this panel passes verification, the verification side crops the named figure(s) (head and shoulders) and commits the ref(s) to the repo. Do not generate any panel that ATTACHes these ref(s) until they exist in refs/.

### i03-pg26-pn3.png — close-up 4:3 — TORCHES ON IDA
ATTACH (fetch from repo refs/ and attach to the generation): refs/cassandra.png
MATCH LINE: 'her wide haunted eyes.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/priam.png, refs/antenor.png
MATCH LINE: map each attending the reading.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/priam.png, refs/antenor.png
MATCH LINE: map each exchanging a satisfied look.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/zeus.png, refs/themis.png
MATCH LINE: map each alone by the golden loom.
...
MATCH LINE: 'her hand on the shining threads.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/zeus.png
MATCH LINE: 'looking down through the cloud-floor, the scepter at rest.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/paris.png
MATCH LINE: 'alone with his herds, playing a reed pipe, utterly at peace.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/paris.png
MATCH LINE: 'behind him, up the darkening path, a golden radiance beginning.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/paris.png
MATCH LINE: 'the tiny piping figure; the four lights nearly upon him.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/singer.png, refs/neleid-prince.png
MATCH LINE: 'the bard's hand flat on the silent strings; the prince struck silent.'
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/singer.png, refs/neleid-prince.png
MATCH LINE: map each: the bard rising with his boy's help; the prince still seated.
...
ATTACH (fetch from repo refs/ and attach to the generation): refs/singer.png
MATCH LINE: 'the bard at the doorway, face to the stars.'
