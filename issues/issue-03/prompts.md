...
THEN CROP: refs/priam.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.
...
THEN CROP: refs/hecuba.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.

### i03-pg05-pn3.png — standard 4:3 — THE TERRACE AT EVENING
ATTACH: refs/priam.png, refs/hecuba.png
...
THEN CROP: refs/antenor.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.

### i03-pg06-pn2.png — standard 4:3 — ANTENOR COUNSELS
ATTACH: refs/antenor.png
...
ATTACH: refs/priam.png, refs/hecuba.png, refs/antenor.png
...
THEN CROP: refs/agelaus.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.

---

### i03-pg10-pn1.png — wide 16:9 — INTO THE WILDS
ATTACH: refs/agelaus.png
...
THEN CROP: refs/paris.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.

### i03-pg11-pn2.png — standard 4:3 — THE FIRE ON THE MOUNTAIN
ATTACH: refs/paris.png, refs/agelaus.png
...
THEN CROP: refs/thetis.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.
...
THEN CROP: refs/peleus.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.

### i03-pg15-pn2.png — wide 16:9 — HOLDING THE GODDESS
ATTACH: refs/peleus.png, refs/thetis.png
...
THEN CROP: refs/chiron.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.
...
THEN CROP: refs/hermes.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.
...
THEN CROP: refs/eris.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.
...
THEN CROP: refs/hera.png, refs/athena.png, refs/aphrodite.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.

### i03-pg18-pn2.png — standard 4:3 — THE MORTAL HOST
ATTACH: refs/peleus.png
...
ATTACH: refs/zeus.png, refs/hera.png, refs/athena.png, refs/aphrodite.png, refs/peleus.png, refs/thetis.png, refs/chiron.png, refs/eris.png
...
ATTACH: refs/chiron.png, refs/peleus.png
...
ATTACH: refs/hera.png, refs/athena.png, refs/aphrodite.png
...
ATTACH: refs/hera.png, refs/athena.png, refs/aphrodite.png, refs/zeus.png
...
ATTACH: refs/hermes.png, refs/zeus.png
...
ATTACH: refs/hermes.png, refs/hera.png, refs/athena.png, refs/aphrodite.png
...
THEN CROP: refs/hector.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.
...
THEN CROP: refs/cassandra.png — crop the named figure(s) tightly (head and shoulders) from this panel before generating any dependent panel.

### i03-pg26-pn3.png — close-up 4:3 — TORCHES ON IDA
ATTACH: refs/cassandra.png
